({
    ...
    yesResponse : function(component, event, helper) {
        ...
        if(capitalRequestRecordstatus == "Closure Approval" || capitalRequestRecordstatus == "Closed"){
        component.set("v.CapitalRequestRecord.Status__c", "Closed");
       component.find("cfrRec").saveRecord($A.getCallback(function(saveResult) {
        if (saveResult.state === "SUCCESS" || saveResult.state === "DRAFT") {
            alert("Closed CFR successfully.");
            ...
            alert('Unknown problem, state: ' + saveResult.state + ', error: ' + 
             ...
             component.set("v.recordSaveError", 'To close the CFR, it should be Closure Approved.');
            alert("To close the CFR, it should be Closure Approved.");
        }
